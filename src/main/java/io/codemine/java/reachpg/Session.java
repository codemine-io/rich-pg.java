 ...
 *
 * <p>The session owns a private HikariCP connection pool built from {@link ReachPgConfig}.
...
public class Session implements AutoCloseable {
     ...
     * {@link ReachPgConfig#transactionRetryAttempts()}. The transaction span is parented to
